  ...
  return new Promise((resolve, reject) => {
    ...
    let sql = `
            ...
            SET 
                ...
                income_type = ${connection.escape(data.income_type)}, 
                expenses_type = ${connection.escape(data.expenses_type)}, 
                financial_date = ${connection.escape(data.financial_date)}, 
                financial_amount = ${connection.escape(data.financial_amount)}, 
                create_date = now(), 
